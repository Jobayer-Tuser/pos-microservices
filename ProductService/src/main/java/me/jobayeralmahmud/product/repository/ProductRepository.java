...
public interface ProductRepository extends JpaRepository<Product, UUID> {
    ...
    /**
     * The method retrieves a product by its ID, along with its associated category.
     * It uses a JPQL query to perform a left join fetch on the category relationship.
     * This ensures that the related entity is loaded eagerly, preventing the N+1 select problem.
     *
